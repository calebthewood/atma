...
const formSchema = z.object({
    ...
    closestAirport: z.string().min(3, { message: "Closest airport must be at least 3 characters." }),
    location: z.string().min(2, { message: "Location must be at least 2 characters." }),
    type: z.string().min(2, { message: "Type must be at least 2 characters." }),
    amenities: z.string().min(2, { message: "Amenities must be at least 2 characters." }),
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input type="email" placeholder="property@example.com" {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
