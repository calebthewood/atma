...
export function HomePageLists({ retreats, properties, hosts }: HomePageListsProps) {
    const [searchResults, setSearchResults] = useState<PropertiesWithImages[] | null>(null);
    console.log('hosts', hosts);
    const updateResults = (list: PropertiesWithImages[]) => setSearchResults(list);
    ...
    const slides = [
        {
            ...
            description: "10 Days of Yoga and Meditation, leave your boyfriend at home!",
            buttonText: "Explore",
        },
        {
